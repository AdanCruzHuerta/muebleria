...
(function ($) {
    ...
    $.fn.fileinput.defaults = {
        ...
        removeLabel: 'Remover',
        removeTitle: 'Borrar imagenes seleccionadas',
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'Imagen "{name}" (<b>{size} KB</b>) exede el tamaño maximo permitido de <b>{maxSize} KB</b>. Por favor ingresa otra imagen!',
        ...
        msgInvalidFileType: 'Tipo de archivo invalido"{name}". Solo "{types}" archivos soportados.',
        ...
        dropZoneTitle: 'Arrasta tu imagen &hellip;',
